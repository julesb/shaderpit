...
vec3 surfaceColour3 = vec3(1.0, 1.0, 1.0);
...
vec3 remnantx_color(vec3 pos, float sphereR) 
{
    ...
    //surfaceColour1 = mix(rainbow2_gradient(palette_offset), surfaceColour1,  pow(smoothstep(0.0, .3, t) * smoothstep(0.6, .3, t), 10.0));
